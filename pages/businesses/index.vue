<template>
  ...
  <main>
    <h2>Westray's Local Business Community</h2>
    <p>Contact information for businesses on Westray</p>
    
<!--    <PageSectionBusinesses />-->
  </main>
</template>
...
// import PageSectionBusinesses from '~/components/page-content/PageSectionBusinesses.vue';
</script>
