<template>
<!-- ~/pages/creative-trail/index.vue -->
  <main>
    <h2>Westray Creative Trail</h2>
    <p>This is the landing page slider to show all the participents in the Creative Trail project</p>
    
<!--    <PageSectionCreativeTrail />-->
  </main>
</template>
...
// import PageSectionCreativeTrail from '~/components/page-content/PageSectionCreativeTrail.vue';
</script>
