...
<!-- ~/pages/articles/index.vue -->
  <main>
    <h2>Westray News Feed</h2>
    <p>Articles and blogs as an island local forum</p>
...
// import PageSectionArticles from '~/components/page-content/articles/PageSectionArticles.vue';
</script>
