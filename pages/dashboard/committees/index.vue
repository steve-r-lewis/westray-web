<template>
<!-- ~/pages/dashboard/committees/index.vue -->
  <NuxtLayout name="layout-dashboard">
    <main class="bg-white pt-4 sm:pt-10 lg:pt-12">
      <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
        <p>Dashboard Committees</p>
        <p>Default page Committees view</p>
      </div>
    </main>
  </NuxtLayout>
</template>
