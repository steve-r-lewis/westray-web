...
<!-- ~/pages/organisations/index.vue -->
  <main>
    <h2>Westray Organisations</h2>
    <p>Organisations like the Westray Development Trust</p>
    
<!--    <PageSectionOrganisations />-->
  </main>
</template>
...
// import PageSectionOrganisations from '~/components/page-content/PageSectionOrganisations.vue';
