<template>
<!-- ~/pages/committees/index.vue -->
  <main>
    <h2>Committees on Westray</h2>
    <p>Listing of Committees for Westray</p>
    
<!--    <PageSectionCommittees />-->
  </main>
</template>
...
// import PageSectionCommittees from '~/components/page-content/PageSectionCommittees.vue';
</script>
