...
<!-- ~/pages/events/index.vue -->
  <main>
    <h2>What's on, on Westray</h2>
    <p>A panelled widget to showcase the events going on for Westray</p>
...
// import PageSectionEvents from '~/components/page-content/PageSectionEvents.vue';
</script>
