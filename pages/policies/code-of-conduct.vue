<template>
<!-- ~/pages/policies/code-of-conduct.vue -->
  <section class="prose dark:prose-invert mx-auto px-4 py-10 max-w-4xl">
    <h1 class="text-3xl font-bold">Code of Conduct</h1>
    <NuxtLink to="/policies">Back to Policies Index</NuxtLink>
    <p>
      The Westray community application promotes a respectful and inclusive environment for all. By using this service,
      you agree to treat others with kindness, engage constructively, and refrain from abusive or discriminatory
      behaviour.
    </p>
    <p>
      Breaches of this code may result in warnings, content removal, or account suspension at the discretion of the
      moderation team.
    </p>
  </section>
</template>
...
definePageMeta({
  ...
  showInSidebar: false,
  navWidgetGroup: 'policies',
  showInNavWidget: true,
  showInNavWidgetDropdown: true,
  parentComponent: '/policies',
});
